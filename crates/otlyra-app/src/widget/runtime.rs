...
/// Stable identity of one independently focused UI root.
///
/// A window can draw several roots at once — chrome, a system page, the
/// inspector, and later popups. Exactly one is active for keyboard, IME,
/// clipboard, and accessibility focus. The id is deliberately opaque: routing
/// compares identities and does not learn what a particular surface contains.
#[derive(Copy, Clone, Debug, PartialEq, Eq, Hash)]
pub struct UiSurfaceId(u64);

impl UiSurfaceId {
    /// A stable id chosen by the application owning the surface.
